package com.laile.security.dsf.service.impl;
...
import com.laile.security.core.dao.file.FileDAO;
import com.laile.security.core.delegate.AbstractDelegate;
import com.laile.security.dsf.constant.UploadConst;
 ...
 */
@Service
public class FileService extends AbstractDelegate<com.laile.security.core.model.file.File, String> implements IFileService {
    ...
    public String add(FileDto fileDto) {
        String filePath = UploadConst.COMMON_PATH;
        ...
        com.laile.security.core.model.file.File record = new com.laile.security.core.model.file.File();
        ...
        record.setSvrAddr(UploadConst.FILE_SERVER);
    ...
    public FileDto download(String fileId) {
        ...
        com.laile.security.core.model.file.File resFileVo = fileDAO.selectByPrimaryKey(fileId);
