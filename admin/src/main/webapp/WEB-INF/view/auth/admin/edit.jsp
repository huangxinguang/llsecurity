...
<form id="data-form" class="layui-form" style="width:80%;" onsubmit="return false;" method="post" enctype="multipart/form-data">
    ...
    <div class="user_left">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
            <textarea placeholder="请输入备注" class="layui-textarea" lay-verify="remark" name="remark" id="area_editor">
                ${admin.remark}
            </textarea>
            </div>
        </div>
    ...
    <div class="user_right">
        ...
        <div class="layui-input-block">
            上传头像
            <div id="preview">
                <img id="pic" src="file/download/${admin.headPic}" border="0" src="static/images/photo_icon.png" width="100" height="100" onclick="$('#previewImg').click();">
            </div>
        </div>
    </div>
